 ...
 * @author rafae
 */
public class DlgCadastroProdutosANTIGO extends javax.swing.JDialog {

    private String produtoSelecionado;
    private boolean editando;
    private GerenciadorProdutosANTIGO gerente;

    public DlgCadastroProdutosANTIGO(boolean modal) {
        this.editando = false;
        ...
        try {
            ...
            Logger.getLogger(DlgCadastroProdutosANTIGO.class.getName()).log(Level.SEVERE, null, ex);
        }
