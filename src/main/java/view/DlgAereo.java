...
public class DlgAereo extends javax.swing.JDialog {
    ...
    private void buscarEtiqueta() {
        ...
        try {
            Etiqueta etiqueta = gerente.buscarEtiqueta(Integer.parseInt(etiquetaSelecionada));
            exibirResultadoBusca(etiqueta);
    ...
    private void exibirResultadoBusca(Etiqueta etiqueta) {
        if (etiqueta == null) {
            JOptionPane.showMessageDialog(this, "A etiqueta ou produto não foi encontrado no sistema.", "Cadastro Inexistente", JOptionPane.WARNING_MESSAGE);
        } else {
            String listagem = gerente.toStringEtiqueta(etiqueta.getNumEtiqueta());
    ...
    private void jButton_RelatorioValidadesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_RelatorioValidadesActionPerformed
        ...
        JOptionPane.showMessageDialog(this, scrollPane, "Listagem de Validades", JOptionPane.INFORMATION_MESSAGE);
